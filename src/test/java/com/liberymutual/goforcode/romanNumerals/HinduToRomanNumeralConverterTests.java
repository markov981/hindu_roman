...
public class HinduToRomanNumeralConverterTests {
    ...
    public void testConversion() {
        String result = converter.mapHinduIntoRomanNumerals(converter.breakNumbIntoArray(input), converter.loadMapOfHinduRomanNumerals());
        assertThat(result).isEqualToIgnoringCase(expectedOutput);
    }
